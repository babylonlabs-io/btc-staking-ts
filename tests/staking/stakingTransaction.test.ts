...
describe("StakingTransaction - Cross env error", () => {
  ...
  const envPairs = [
    {
      mainnetDataGenerator: mainnet.observableStakingDatagen,
      testnetDataGenerator: testnet.observableStakingDatagen
    },
    // TODO: Add stakingDataGenerator for other staking types
  ];
...
describe.each(testingNetworks)("stakingTransaction", (
...
const validateCommonFields = (
  ...
  // TODO: Add this to the observable staking tx test
  // expect(
