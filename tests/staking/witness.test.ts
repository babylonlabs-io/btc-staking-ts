...
describe("createWitness", () => {
  it("should return only originalWitness if no matches found", () => {
    ...
    const covenantSigs = [
      { btcPkHex: "6e6f6e6578697374656e74", sigHex: "7369676e6174757265" }, // 'nonexistent' and 'signature' in hex
    ];
  ...
  it("should return the correct witness when multiple covenants are matched", () => {
    ...
    const covenantSigs = [
      { btcPkHex: "636f76656e616e7431", sigHex: "7369676e617475726531" }, // 'covenant1' and 'signature1' in hex
